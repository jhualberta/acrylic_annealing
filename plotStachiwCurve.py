...
print("    timeRegion1 = (140. - %.f)/%.f"%(room_temp,max_heatingRate_degC))
print("    timeRegion2 = timeRegion1 + %.f"%holdtime_at140degC)
print("    timeRegion3 = timeRegion2 + (140. - 110.)/abs(%.2f)"%coolingRate_to110degC)
print("    timeRegion4 = timeRegion3 + %.f"%holdtime_at110degC)
print("    timeRegion5 = timeRegion4 + (110. - %.f)/abs(%.2f)"%(room_temp,max_coolingRate_to27degC))
print("")
print("    if 0 <= t<= timeRegion1:")
print("        return %.2f*t + %.f"%(max_heatingRate_degC,room_temp))
