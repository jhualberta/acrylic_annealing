...
def handle_cycleMode_1_2(inputdata):
    ...
    print(round(holdTime_at140degC,2), "hours; or", round(holdTime_at140degC*60,2), "minutes.")
    print("------------------------------------------------------")
    print(u"Approx. cooling rate to 110 \N{DEGREE SIGN}C:")
    print(round(coolingRate_to110degC,2), u"\N{DEGREE SIGN}C/hour; or", round(coolingRate_to110degC/60,2), u"\N{DEGREE SIGN}C/minute or", round(coolingRate_to230F,2), u"\N{DEGREE SIGN}F/hour")
    print("------------------------------------------------------")
    print(u"Hours to Cool oven to 110 \N{DEGREE SIGN}C:")
    print(round(decreasetime_to110degC,2),"hours; or", round(decreasetime_to110degC*60,2),"minutes")
    print("------------------------------------------------------")
    ...
    print(round(max_coolingRate_to27degC,2), u"\N{DEGREE SIGN}C/hour; or", round(max_coolingRate_to27degC/60,2), u"\N{DEGREE SIGN}C/minute or ", round(max_coolingRate_to80F,2), u"\N{DEGREE SIGN}F/hour")
    print("------------------------------------------------------")
    print("Time for cooling to room temperature: ")
    cooling_time = (110. - room_temp)/max_coolingRate_to27degC
    print(round(cooling_time,2), " hours; or", round(cooling_time*60,2), "minutes.")
    print("------------------------------------------------------")
    print("Total time expected in Stachiw's table:")
    print(totaltime, " hours; or", round(totaltime*60, 2), "minutes.")
